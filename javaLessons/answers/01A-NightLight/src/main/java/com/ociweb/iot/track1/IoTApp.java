...
/**
 * As it gets dark the back light of the LCD comes on. Angle sensor is used for
...
public class IoTApp implements FogApp {
	...
	public void declareBehavior(FogRuntime runtime) {
		...
		final FogCommandChannel lcdScreenChannel = runtime
				.newCommandChannel(GreenCommandChannel.DYNAMIC_MESSAGING | FogRuntime.I2C_WRITER);
		runtime.addAnalogListener((port, time, durationMillis, average, value) -> {

			switch (port) {
			case A2:
				assert (port == LIGHT_SENSOR_PORT);
